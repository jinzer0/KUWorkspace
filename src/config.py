...
EQUIPMENT_ASSETS_FILE = DATA_DIR / "equipment_assets.txt"
...
TIME_SLOT_MINUTES = 30  # 시간 단위 (30분)
MAX_ACTIVE_ROOM_BOOKINGS = 3  # 회의실 최대 활성 예약 수
MAX_ACTIVE_EQUIPMENT_BOOKINGS = 3  # 장비 최대 활성 예약 수

# 패널티 상수
NO_SHOW_PENALTY = 3  # 노쇼 패널티 점수
LATE_CANCEL_PENALTY = 2  # 직전 취소 패널티 점수
MAX_DAMAGE_PENALTY = 5  # 파손/오염 최대 패널티 점수
NO_SHOW_GRACE_MINUTES = 15  # 노쇼 판정 유예 시간 (분)
